...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative backdrop-blur-sm bg-opacity-90 shadow-xl rounded-full border border-transparent dark:bg-black  bg-gray-50 shadow-input flex justify-center space-x-8 px-4 py-2"
    >
